...
public class RandomValueGenerate {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 100; i++) {
			...
			//System.out.println("<MarksAndNumbers1>" + rand.nextInt(1000000000) + rand.nextInt(1000000000) + rand.nextInt(100) + "</MarksAndNumbers1>");
			...
			System.out.println("<BuyerPartNumber>" + "MB" + rand.nextInt(10000) + "</BuyerPartNumber>");
			System.out.println("<VendorPartNumber>" + "MB" + rand.nextInt(10000) + "</VendorPartNumber>");
