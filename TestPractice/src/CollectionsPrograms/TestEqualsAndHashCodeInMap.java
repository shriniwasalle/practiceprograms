...
public class TestEqualsAndHashCodeInMap {
	...
	public static void main(String[] args) {
		...
		// This will print the size = 2 and allowing duplicates, bcz equals and hashcode
		// is not overrided
		...
		// This will print the size = 1, bcz Integer wrapper class has equals and
		// hashcode methods overrided
